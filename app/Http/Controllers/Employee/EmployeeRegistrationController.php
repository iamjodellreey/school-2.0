...
class EmployeeRegistrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school.employee.registration.index', [
    ...
    public function create()
    {
        ...
        return view('school.employee.registration.create', [
    ...
    public function store(Request $request)
    {
       ...
       // TODO: APPLY ALERT MESSAGEs
        // $notification = array(
        //     'message' => 'Employee Registration Inserted Successfully',
        //     'alert-type' => 'success'
        // );

        return redirect()->route('employees.registration.index');
    }
    ...
    public function edit($employeeId)
    {
        ...
        return view('school.employee.registration.edit', [
    ...
    public function update(Request $request, $employeeId)
    {
        ...
        // TODO: APPLY ALERT MESSAGE
        // $notification = array(
        //     'message' => 'Employee Registration Updated Successfully',
        //     'alert-type' => 'success'
        // );

        return redirect()->route('employee.registration.index');
    }
    ...
    public function details($employeeId)
    {
        ...
        $pdf = PDF::loadView('school.employee.registration.details', $data);
