...
class ExamFeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('school.student.fee.exam.index', [
            'years' => $data['years'],
    ...
    public function feeClassData(Request $request)
    {
        ...
        foreach ($allStudent as $key => $v) {
            ...
            $html[$key]['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="PaySlip" target="_blanks" href="'.route("students.exam.fee.payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'&exam_type_id='.$request->exam_type_id.' ">Fee Slip</a>';
            $html[$key]['tdsource'] .= '</td>';
    ...
    public function payslip(Request $request)
    {
        ...
        $pdf = PDF::loadView('school.student.fee.exam.details', $data);
