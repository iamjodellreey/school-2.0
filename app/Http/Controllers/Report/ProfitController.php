...
class ProfitController extends Controller
{
    ...
    {
        return view('school.report.profit.index');
    }
    ...
    public function dateWise(Request $request)
    {
        ...
        $html['tdsource'] .='<td>';
        $html['tdsource'] .='<a class="btn btn-sm btn-'.$color.'" title="PDF" target="_blanks" href="'.route("reports.monthly.profit.pdf").'?start_date='.$sdate.'&end_date='.$edate.'">Pay Slip</a>';
        $html['tdsource'] .= '</td>';
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = PDF::loadView('school.report.profit.details', $data);
