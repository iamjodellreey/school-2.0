...
class AccountStudentFeeController extends Controller
{
    public function index()
    {
        ...
        return view('school.account.student_fee.index', [
    ...
    public function create()
    {
        ...
        return view('school.account.student_fee.create', [
            'years' => $data['years'],
    ...
    public function getStudent(Request $request)
    {
        ...
        $data = Student::with(['discount'])->where('year_id',$year_id)->where('class_id',$class_id)->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accounts.student.fee.index');
