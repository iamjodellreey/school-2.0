            ...
            @foreach ($designationList as $key => $designation)
                <tr>
                    ...
                    <td class="align-middle">
                        ...
                        <a href="{{ route('setups.designation.create') }}" class="text-secondary font-weight-bold text-xs"
                            data-toggle="tooltip" data-original-title="Edit user"><i class="material-icons opacity-10">
                                add_circle
                            </i>
                        </a>

                        <a href="{{ route('setups.designation.edit', $designation->id) }}"
                            class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                            data-original-title="Edit user"><i class="material-icons opacity-10">
                                edit
                            </i>
                        </a>
                        <a href="{{ route('setups.designation.delete', $designation->id) }}"
                            class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
